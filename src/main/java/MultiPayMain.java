...
public class MultiPayMain {
    public static void main(String[] args) throws IllegalAccessException {
        ...
        CreateExpenseRequest expenseRequest2 = new CreateExpenseRequest.Builder()
                ...
                .totalAmount(2000)
                .groupId(oGs.getId())
                .paymentStrategyType(PayerStrategy.MULTI)
                .payersMap(Map.of(ada, 1000.00, grace, 1000.00))
                .splitStrategyType(SplitStrategyType.EQUAL)
                .build();
        ...
        expenseController.createExpense(
                new CreateExpenseRequest.Builder()
                        ...
                        .groupId(oGs.getId())
                        .paymentStrategyType(PayerStrategy.MULTI)
                        .payersMap(Map.of(claude, 2500.0, charles, 1000.0, ada, 500.0, alan, 1000.0))
                        .splitStrategyType(SplitStrategyType.EXACT_AMOUNT)
                        .splitExactAmountMap(Map.of(grace, 2500.0, ada, 2500.0))
                        .build()
        );
        ...
        List<Transaction> allTransactions = groupController.settleUp(oGs.getId());
